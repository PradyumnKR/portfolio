...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#0e0c09] border-t border-[rgba(200,169,110,0.2)] px-12 pt-10 pb-8 relative z-50">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-6 md:gap-0">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <div className="font-mono text-[13px] font-bold text-[#c8a96e] tracking-[0.25em]">
              PRADYUMN <span className="text-[rgba(200,169,110,0.5)] tracking-[0.15em] font-normal ml-2">// THE ARCHIVIST</span>
            </div>
            <div className="font-mono text-[9px] text-[rgba(200,169,110,0.35)] tracking-[0.15em] mt-[6px] uppercase">
              Digital Scriptorium // Est. 1892
            </div>
          </div>
          ...
          <div className="flex flex-col items-center md:items-end text-center md:text-right">
            ...
            <div className="font-mono text-[10px] text-[rgba(200,169,110,0.5)] tracking-[0.15em] mt-[6px] uppercase">
